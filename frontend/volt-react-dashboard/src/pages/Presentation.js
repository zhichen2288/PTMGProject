...
import ThemesbergLogoIcon from "../assets/img/StevensCircular.png";
import ThemesbergLogo from "../assets/img/StevensCircular.png";
...
export default () => {
  ...
  return (
    <>
      ...
      <section
        className="section-header overflow-hidden bg-primary text-white"
        id="home"
      >
        <Container>
          <Row>
            <Col xs={12} className="text-center">
              ...
              <h1 className="fw-bolder text-secondary">PTMG Beta Dashboard</h1>
              <p className="text-muted fw-light mb-5 h5">
                Click on Explore Dashboard to get started
              </p>
                ...
                <div className="text-center">
                  <a href="https://www.stevens.edu/" target="_blank">
                    ...
                    <p className="text-muted font-small m-0">
                      Hanlon Financial Systems Center, Stevens Institute of
                      Technology
                    </p>
                  </a>
                </div>
            ...
            <Col className="mb-md-2">
              ...
              >
                <p className="font-weight-normal font-small mb-0">
                  Copyright © Hanlon Financial Systems Center 2021-
